            ...
            header.innerHTML = `
                ...
                <div class="restaurant-info">
                    ...
                    <p class="restaurant-meta">
                        <span><span class="pin-icon"></span> ${data.city}</span>
                        <span><span class="star-icon"></span> ${data.rating.toFixed(1)}</span>
            ...
            data.reviews.forEach(review => {
                ...
                card.innerHTML = `
                    ...
                    <div class="review-ratings">
                        <span>Taste: ${Array(review.tasteRating).fill('<span class="star-icon"></span>').join('')}</span>
                        <span>Ambiance: ${Array(review.ambianceRating).fill('<span class="star-icon"></span>').join('')}</span>
                        <span>Overall: ${Array(review.overallRating).fill('<span class="star-icon"></span>').join('')}</span>
                    </div>
